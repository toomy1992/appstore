...
This directory contains all the applications available in this app store. Each application is organized into its own folder with the following structure:
